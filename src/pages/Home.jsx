    ...
    <PageShell>
      <div className="grid gap-6">
          ...
          <div className="mt-6 grid gap-10 lg:grid-cols-12 lg:items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="mt-4 max-w-2xl text-lg text-white/70">
                Secure Inventory & Document Management system with role-based access,
                authentication, and audit-friendly design.
              </p>
                ...
                {!user ? (
                  ...
                  <>
                    ...
                    <div className="flex items-center rounded-2xl px-4 py-3 text-sm bg-white/10 ring-1 ring-white/10 text-white">
                      Signed in as <b className="ml-1 mr-1">{profile?.name || user.email}</b> •
                      <b className="ml-1 px-2 py-0.5 rounded-full bg-white/20 text-xs">{profile?.role || "staff"}</b>
                    </div>
                  </>
                )}
              </div>
            ...
            <div className="lg:col-span-5 relative">
              ...
              <div className="relative rounded-3xl bg-white/[0.04] ring-1 ring-white/10 p-6 md:p-8 backdrop-blur-sm">
                <div className="text-sm font-medium text-white/70 mb-4">Core Features</div>
                <div className="grid gap-4 sm:grid-cols-2">
                  <FeatureCard title="Email + Google" desc="Fast login with Firebase Auth." />
                  <FeatureCard title="Role Based" desc="Admin/Staff routing and permissions." />
                  <FeatureCard title="Cloud Firestore" desc="Profiles + inventory/docs." />
                  <FeatureCard title="Audit Friendly" desc="Ready for logs & approvals." />
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="grid gap-4 sm:grid-cols-3 mt-4">
          <FeatureCard title="Authentication" desc="Robust Firebase Auth supporting both email/password and secure Google sign-in methods." />
          <FeatureCard title="Access Control" desc="Strict context-aware role-based permissions safely stored and verified in Firestore documents." />
          <FeatureCard
            title="Database"
            desc="Blazing fast Cloud Firestore providing live updates for users, inventory & documents modules."
          />
        </section>
      </div>
    </PageShell>
